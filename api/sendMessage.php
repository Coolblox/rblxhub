...
$userq = mysqli_query($connect, "SELECT * FROM users WHERE id='$uid'") or die(mysqli_error($connect));
...
if ($replyto != 0) {
  $mq = mysqli_query($connect, "SELECT * FROM messages WHERE user_from='$uid' AND user_to='{$_USER['id']}' AND id='$replyto'") or die(mysqli_error($connect));
	...
	<div id="MessagePane" >
	    <?php
              if (isset($_POST['subject'])) {
                ...
                $message = nl2br(htmlspecialchars(mysqli_real_escape_string($connect, $_POST['message'])));
