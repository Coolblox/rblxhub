...
<div id="Body">
    ...
    <div style="margin-top: 12px; margin-bottom: 12px">
        ...
        <div id="InstallStep1" style="padding-left: 60px">
            ...
            <p><input type="submit" name="ctl00$cphRoblox$ButtonDownload" value="Install <?=$sitename?>" id="ctl00_cphRoblox_ButtonDownload" disabled="disabled" class="BigButton"/></p>
        </div>
        ...
        <div id="InstallStep2" style="padding-left: 60px">
            ...
            <p><img id="ctl00_cphRoblox_Image1" src="https://web.archive.org/web/20080725020407im_/http://www.roblox.com/images/Install/DownloadPrompt.PNG" border="0"/></p>
        </div>
        ...
        <div id="InstallStep3" style="padding-left: 60px">
            ...
            <p><img id="ctl00_cphRoblox_Image2" src="https://web.archive.org/web/20070419164552im_/http://www.roblox.com/images/Install/Wizard.PNG" border="0"/></p>
        </div>
    </div>
