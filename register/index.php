...
<form method="POST" action="">
		<div id="Registration">
			<div id="ctl00_cphRoblox_upAccountRegistration">
                    ...
                    <div id="EnterEmail">
						<fieldset title="Provide a beta key">
							<legend>Beta Key</legend>
							<div class="Suggestion">
								Please provide a beta key
							</div>
							<div class="Validators">
								<div></div>
								<div></div>
							...
							<div class="EmailRow">
								<label for="ctl00_cphRoblox_TextBoxEMail" id="ctl00_cphRoblox_LabelEmail" class="Label">Beta Key:</label>&nbsp;<input type="text" name="betakey" id="ctl00_cphRoblox_TextBoxEMail" tabindex="4" class="TextBox">
							</div>
						</fieldset>
                    </div>
                    <div id="EnterPassword">
